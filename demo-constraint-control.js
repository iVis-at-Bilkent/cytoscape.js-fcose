...
let onLoad = function(){
  let nodeList = "<select style='background-color: #64ffee;' id='nodeList' onchange='onSelect()'>";
  ...
  let nodeListRP1 = "<select style='background-color: #64ffee;' id='nodeListRP1' onchange='onSelectRP1()'>";
  for(let i = 0; i < simpleNodes.length; i++){
    let node = simpleNodes[i];
    let label = (node.data('label'))?(node.data('label')):(node.id());    
  ...
  let nodeListRP2 = "<select style='background-color: #64ffee;' id='nodeListRP2' onchange='onSelectRP2()'>";
  for(let i = 0; i < simpleNodes.length; i++){
    let node = simpleNodes[i];
    let label = (node.data('label'))?(node.data('label')):(node.id());    
