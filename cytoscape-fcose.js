...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__abstractMatrix__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__matrix__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__abstractMatrix__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wrap_wrap__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__wrap_WrapperMatrix2D__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__wrap_WrapperMatrix1D__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__decompositions__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__linearDependencies__ = __webpack_require__(22);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "linearDependencies", function() { return __WEBPACK_IMPORTED_MODULE_6__linearDependencies__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__dc_svd_js__ = __webpack_require__(5);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "SingularValueDecomposition", function() { return __WEBPACK_IMPORTED_MODULE_7__dc_svd_js__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "SVD", function() { return __WEBPACK_IMPORTED_MODULE_7__dc_svd_js__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dc_evd_js__ = __webpack_require__(20);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "EigenvalueDecomposition", function() { return __WEBPACK_IMPORTED_MODULE_8__dc_evd_js__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "EVD", function() { return __WEBPACK_IMPORTED_MODULE_8__dc_evd_js__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__dc_cholesky_js__ = __webpack_require__(19);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "CholeskyDecomposition", function() { return __WEBPACK_IMPORTED_MODULE_9__dc_cholesky_js__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "CHO", function() { return __WEBPACK_IMPORTED_MODULE_9__dc_cholesky_js__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__dc_lu_js__ = __webpack_require__(7);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "LuDecomposition", function() { return __WEBPACK_IMPORTED_MODULE_10__dc_lu_js__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "LU", function() { return __WEBPACK_IMPORTED_MODULE_10__dc_lu_js__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__dc_qr_js__ = __webpack_require__(10);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "QrDecomposition", function() { return __WEBPACK_IMPORTED_MODULE_11__dc_qr_js__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "QR", function() { return __WEBPACK_IMPORTED_MODULE_11__dc_qr_js__["a"]; });
...
class Matrix extends __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__abstractMatrix__["a" /* default */])(Array) {
   ...
   */
  removeRow(index) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* checkRowIndex */])(this, index);
    if (this.rows === 1) {
  ...
  addRow(index, array) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* checkRowIndex */])(this, index, true);
    array = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["b" /* checkRowVector */])(this, array, true);
   ...
   */
  removeColumn(index) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["c" /* checkColumnIndex */])(this, index);
    if (this.columns === 1) {
  ...
  addColumn(index, array) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["c" /* checkColumnIndex */])(this, index, true);
    array = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["d" /* checkColumnVector */])(this, array);
    for (var i = 0; i < this.rows; i++) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ml_array_rescale__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dc_lu__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dc_svd__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_transpose__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__views_row__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__views_sub__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__views_selection__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__views_rowSelection__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__views_columnSelection__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__views_column__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__views_flipRow__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__views_flipColumn__ = __webpack_require__(25);
...
function AbstractMatrix(superCtor) {
  ...
  class Matrix extends superCtor {
    ...
    scaleRows(min, max) {
      ...
      for (var i = 0; i < this.rows; i++) {
        var scaled = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_ml_array_rescale__["a" /* default */])(this.getRow(i), { min, max });
    ...
    scaleColumns(min, max) {
      ...
      var newMatrix = this.constructor.empty(this.rows, this.columns);
      for (var i = 0; i < this.columns; i++) {
        var scaled = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_ml_array_rescale__["a" /* default */])(this.getColumn(i), {
          min: min,
          max: max
        });
    ...
    det() {
      if (this.isSquare()) {
        ...
        if (this.columns === 2) {
          ...
          return new __WEBPACK_IMPORTED_MODULE_1__dc_lu__["a" /* default */](this).determinant;
        }
      } else {
    ...
    pseudoInverse(threshold) {
      ...
      var svdSolution = new __WEBPACK_IMPORTED_MODULE_2__dc_svd__["a" /* default */](this, { autoTranspose: true });
    ...
    while (p > 0) {
      ...
      switch (kase) {
        case 1: {
          ...
          e[p - 2] = 0;
          for (let j = p - 2; j >= k; j--) {
            let t = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* hypotenuse */])(s[j], f);
            let cs = s[j] / t;
            let sn = f / t;
            s[j] = t;
            if (j !== k) {
        ...
        case 3: {
          ...
          let g = sk * ek;
          for (let j = k; j < p - 1; j++) {
            let t = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* hypotenuse */])(f, g);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_any_array__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_any_array___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_is_any_array__);
...
function max(input) {
  if (!__WEBPACK_IMPORTED_MODULE_0_is_any_array___default()(input)) {
...
class QrDecomposition {
  constructor(value) {
    ...
    for (k = 0; k < n; k++) {
      var nrm = 0;
      for (i = k; i < m; i++) {
        nrm = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* hypotenuse */])(nrm, qr.get(i, k));
      }
      if (nrm !== 0) {
        if (qr.get(k, k) < 0) {
          nrm = -nrm;
...
var impl = __webpack_require__(13);
...
var SVD = __webpack_require__(1).SVD;
  ...
  _createClass(Layout, [{
    ...
    value: function run() {
      ...
      var sample = function sample() {
        ...
        var a_A = Matrix.zeros(sampleSize, sampleSize);
        ...
        var SVDResult = new SVD(a_A);
        var a_w = SVDResult.diagonal;
        var a_u = SVDResult.leftSingularVectors;
        var a_v = SVDResult.rightSingularVectors;
        ...
        var a_Sig = Matrix.zeros(sampleSize, sampleSize);

        for (var _i10 = 0; _i10 < sampleSize; _i10++) {
          for (var _j2 = 0; _j2 < sampleSize; _j2++) {
            if (_i10 == _j2) {
              a_Sig.set(_i10, _j2, a_w[_i10] / (a_w[_i10] * a_w[_i10] + max_s / (a_w[_i10] * a_w[_i10])));
            }
          }
        }

        var a_INV = Matrix.zeros(sampleSize, sampleSize);
        ...
        for (var _i11 = 0; _i11 < sampleSize; _i11++) {
          for (var _j3 = 0; _j3 < sampleSize; _j3++) {
            INV[_i11 + 1][_j3 + 1] = a_INV.get(_i11, _j3);
          }
        }
      };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ml_array_max__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ml_array_min__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_is_any_array__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_is_any_array___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_is_any_array__);
...
function rescale(input) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_2_is_any_array___default()(input)) {
    throw new TypeError('input must be an array');
  ...
  if (options.output !== undefined) {
    if (!__WEBPACK_IMPORTED_MODULE_2_is_any_array___default()(options.output)) {
  ...
  var currentMin = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_ml_array_min__["a" /* default */])(input);
  var currentMax = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_ml_array_max__["a" /* default */])(input);
...
/* harmony default export */ __webpack_exports__["a"] = (rescale);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dc_lu__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dc_qr__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dc_svd__ = __webpack_require__(5);
...
function inverse(matrix, useSVD = false) {
  matrix = __WEBPACK_IMPORTED_MODULE_3__index__["WrapperMatrix2D"].checkMatrix(matrix);
  if (useSVD) {
    return new __WEBPACK_IMPORTED_MODULE_2__dc_svd__["a" /* default */](matrix).inverse();
  } else {
    return solve(matrix, __WEBPACK_IMPORTED_MODULE_3__index__["Matrix"].eye(matrix.rows));
  }
}
...
function solve(leftHandSide, rightHandSide, useSVD = false) {
  leftHandSide = __WEBPACK_IMPORTED_MODULE_3__index__["WrapperMatrix2D"].checkMatrix(leftHandSide);
  rightHandSide = __WEBPACK_IMPORTED_MODULE_3__index__["WrapperMatrix2D"].checkMatrix(rightHandSide);
  if (useSVD) {
    return new __WEBPACK_IMPORTED_MODULE_2__dc_svd__["a" /* default */](leftHandSide).solve(rightHandSide);
  } else {
    return leftHandSide.isSquare()
      ? new __WEBPACK_IMPORTED_MODULE_0__dc_lu__["a" /* default */](leftHandSide).solve(rightHandSide)
      : new __WEBPACK_IMPORTED_MODULE_1__dc_qr__["a" /* default */](leftHandSide).solve(rightHandSide);
  }
}
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = linearDependencies;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ml_array_max__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__matrix__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dc_svd__ = __webpack_require__(5);
...
function linearDependencies(matrix, options = {}) {
  ...
  var n = matrix.rows;
  var results = new __WEBPACK_IMPORTED_MODULE_1__matrix__["a" /* default */](n, n);

  for (var i = 0; i < n; i++) {
    var b = __WEBPACK_IMPORTED_MODULE_1__matrix__["a" /* default */].columnVector(matrix.getRow(i));
    var Abis = matrix.subMatrixRow(xrange(n, i)).transposeView();
    var svd = new __WEBPACK_IMPORTED_MODULE_2__dc_svd__["a" /* default */](Abis);
    var x = svd.solve(b);
    var error = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_ml_array_max__["a" /* default */])(
      __WEBPACK_IMPORTED_MODULE_1__matrix__["a" /* default */].sub(b, Abis.mmul(x))
        .abs()
        .to1DArray()
    );
    results.setRow(
...
class MatrixColumnSelectionView extends __WEBPACK_IMPORTED_MODULE_1__base__["a" /* default */] {
  constructor(matrix, columnIndices) {
    columnIndices = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["j" /* checkColumnIndices */])(matrix, columnIndices);
...
class MatrixRowSelectionView extends __WEBPACK_IMPORTED_MODULE_1__base__["a" /* default */] {
  constructor(matrix, rowIndices) {
    rowIndices = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["k" /* checkRowIndices */])(matrix, rowIndices);
...
class MatrixSelectionView extends __WEBPACK_IMPORTED_MODULE_1__base__["a" /* default */] {
  constructor(matrix, rowIndices, columnIndices) {
    var indices = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["i" /* checkIndices */])(matrix, rowIndices, columnIndices);
...
class MatrixSubView extends __WEBPACK_IMPORTED_MODULE_1__base__["a" /* default */] {
  constructor(matrix, startRow, endRow, startColumn, endColumn) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["h" /* checkRange */])(matrix, startRow, endRow, startColumn, endColumn);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__WrapperMatrix1D__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__WrapperMatrix2D__ = __webpack_require__(12);
